...
const FATOR_ATIVIDADE = [
  ...
  {
    label: "Levemente ativo (Exercício leve, 1 a 3 dias/semana)",
    value: 1.375
  },
      ...
      results => {
        ...
        Alert.alert(
          ...
          [
            {
              text: "Continuar",
              onPress: () => this.props.navigation.dispatch(novaPilha)
            }
          ],
          { cancelable: false }
        );
    ...
    return (
      <ScrollView style={FormStyle.fundo}>
        <UserInput
          ...
          value={nome}
          informacao="Seu nome que ficará logo abaixo do avatar."
        ...
        <UserInput
          ...
          value={frase}
          informacao="Uma frase que será exibida abaixo do seu perfil."
          keyboardType="default"
        ...
        <UserInput
          label="Peso (Kg)"
          value={peso}
          informacao="Informe seu peso, pra realizar os calculos de consumo calórico."
        ...
        <UserInput
          label="Altura (cm)"
          value={altura}
          informacao="Informe sua altura, pra realizar os calculos de consumo calórico."
          keyboardType="numeric"
        ...
        <UserInput
          label="Idade"
          value={idade}
          informacao="Sua idade também é necessária para os calculos de consumo calórico."
          keyboardType="numeric"
        ...
        <UserPicker
          ...
          onValueChange={newValue =>
            this.handlePicker("fatorAtividade", newValue)
          }
        />

        <TouchableOpacity
          onPress={() => this.verificarDados()}
          style={FormStyle.botaoSalvar}
        >
